...
public class FakeMovieSessionRepo implements MovieSessionRepository{
    ...
    private List<MovieSession> create()
    {
        ...
        movieSessions.add(new MovieSession(1, 210, Timestamp.valueOf("2018-09-01 08:01:15"), "AVATAR", "https://image.cnbcfm.com/api/v1/image/105897632-1557241558937avatar-e1541360922907.jpg?v=1664130328&w=1920&h=1080" ));
        movieSessions.add(new MovieSession(2, 210, Timestamp.valueOf("2019-09-01 09:01:15"), "Форсаж", "https://whatisgood.ru/wp-content/uploads/2021/06/o-filme-forsazh-9-1.jpg" ));
        movieSessions.add(new MovieSession(3, 210, Timestamp.valueOf("2022-09-01 07:01:15"), "Початок", "https://prm.ua/wp-content/uploads/2018/08/150417_pochatok.jpg" ));
